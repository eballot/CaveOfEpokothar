kItemsData.ammo = {
	...
	arrow: {
		displayName: $L("Arrow"),
		type: "arrow", category:"ammo", slot:"quiver", skill: "bow", attackActions:"pierce", weight:0.15, value:0.5,/*gp*/
		damageMin:0, damageRnd:0, canConsolidate: true, destroyedWhenUsed: 0.25,
		description: $L("Arrows are shot from a bow.")
	},
	crossbowbolt: {
		displayName: $L("Bolt"),
		type: "crossbowbolt", category:"ammo", slot:"quiver", skill: "crossbow", attackActions:"pierce", weight:0.15, value:0.5,/*gp*/
		damageMin:0, damageRnd:0, canConsolidate: true, destroyedWhenUsed: 0.25,
		description: $L("A bolt is fired from a crossbow.")
	},
	slingstone: {
		displayName: $L("Sling stone"),
		type: "slingstone", category:"ammo", slot:"quiver", skill: "sling", attackActions:"bludgeon", weight:0.15, value:0.1,/*gp*/
	...
	slingbullet: {
		...
		type: "slingbullet", category:"ammo", slot:"quiver", skill: "sling", attackActions:"bludgeon", weight:0.25, value:0.75,/*gp*/
