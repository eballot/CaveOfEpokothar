...
var kMonsterData = {
	...
	dwarf:{
		monsterName:$L("Dwarf"), xp:2, hpMin:2, hpRnd:6, defenses:{dodge:6, block:3, ac:10}, dex:9, hands:2, showEquippedImg:true,
	...
	spider:{
		monsterName:$L("Redback Spider"), xp:2, hpMin:3, hpRnd:4, defenses:{dodge:6, block:3, ac:3}, hands:0, attacks:[{type:"bitesmall", extras:{special:"poison", bonus:-1}}],
		img:"tiles/dc-mon0/redback.gif", corpse:"insectoid", corpseImg:"deadInsect"
	},
	walkingmushroom:{
		monsterName:$L("Walking Mushroom"), xp:1, hpMin:4, hpRnd:6, defenses:{dodge:1, block:9, ac:10}, hands:0, attacks:[{type:"bludgeonlarge", extras:{bonus:-3}}],
